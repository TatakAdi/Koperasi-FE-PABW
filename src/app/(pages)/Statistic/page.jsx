...
export default function StatAdminPage() {
  return (
    <div className="w-auto h-[1024px] relative bg-white">
      {/* Navbar */}
      <div className="w-full h-[88px] left-0 top-0 absolute bg-white border-b overflow-hidden z-10">
        <Navbar />
      </div>
      {/* Sidebar */}
      ...
      {/* Main Content */}
      <div className="w-auto h-full px-5 py-4 left-[316px] top-[88px] absolute bg-white rounded-xl flex flex-col gap-12">
        {/* Profit Details */}
        <div className="w-full flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <div className="text-black text-2xl font-medium font-[Geist]">Profit Details</div>
            <div className="text-neutral-500 text-base font-medium font-[Geist]">Lihat riwayat dari pendapatan</div>
          </div>
        ...
        <div className="w-full flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <div className="text-black text-2xl font-medium font-[Geist]">Products Sold</div>
          ...
          <div className="w-full flex flex-col gap-6 ">
            <div className="w-full flex flex-col">
              ...
              <div className="w-full flex flex-col overflow-hidden mx-auto">
                {[
                  { name: "Roti O Lempuyangan", sold: 12, price: "Rp. 16.000.000" },
                  { name: "Lato-Lato asli “Mojokerto”", sold: 1, price: "Rp. 12.000.000" },
                  { name: "Buah Khuldi asli “Samarinda”", sold: 7, price: "Rp. 178.194.500" },
                  { name: "Holland Bakery cabang “Grobogan”", sold: 7, price: "Rp. 178.194.500" },
                  { name: "Tanah Longsor “Himalaya”", sold: 7, price: "Rp. 178.194.500" },
                  { name: "Badai Topan selat “Karimata”", sold: 7, price: "Rp. 178.194.500" },
                  { name: "Rambutan khas “Ponorogo”", sold: 7, price: "Rp. 178.194.500" },
                  { name: "Lato-Lato asli “Mojokerto”", sold: 1, price: "Rp. 12.000.000" },
                  { name: "Buah Khuldi asli “Samarinda”", sold: 7, price: "Rp. 178.194.500" },
                  { name: "Roti O Lempuyangan", sold: 12, price: "Rp. 16.000.000" },
                ].map((item, idx, arr) => (
